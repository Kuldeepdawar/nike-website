  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="flex
        justify-center items-start flex-wrap w-full mt-20 gap-16
        "
        >
          {/*I am using map here to get all data from stattis like value: '1k+', label: 'Brands'*/}
          {statistics.map((stat) => (
            <div key={stat.label}>
      ...
      "
        ...
        >
          {shoes.map((shoe) => (
            <div key={shoe}>
              {/*import my show here by map and import component*/}
              <ShoeCard
                imgURL={shoe}
